    ...
    <div class="col-span-2 group flex items-center">
      <div class="rounded-full p-1 duration-300  group-hover:bg-emerald-400/20">
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          class="w-5 h-5 group-hover:fill-emerald-500 dark:fill-gray-300"
        >
          <g>
            <path
    ...
    <div class="col-span-2 flex items-center">
      ...
      <div class="rounded-full p-1 duration-300 hover:bg-blue-400/20"> 
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          class="w-5 h-5 hover:fill-blue-500 dark:fill-gray-300 r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1xvli5t r-1hdv0qi"
        >
          <g>
            <path
