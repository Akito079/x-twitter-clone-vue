...
const openDrawer = () => {
  const $targetEl = document.querySelector("#drawer-example");
  ...
  <Teleport to="body">
    ...
    >
      ...
      <div class="flex flex-col gap-3">
        ...
        <!-- username -->
        <div class="px-4">
          <h3 class="font-bold dark:text-white">{{ user.name }}</h3>
        ...
        <div class="flex px-4 items-center gap-5">
          <div class="text-gray-500 dark:text-gray-300">
            <b>{{ user.followings }}</b> Followings
          </div>
          <div class="text-gray-500 dark:text-gray-300">
            <b>{{ user.followers }}</b> follwers
          </div>
        </div>
        ...
        <div class="flex flex-col">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              class="w-6 h-6 rounded-full dark:fill-gray-300"
              data-testid="icon"
            >
              <g>
                <path
