...
); //to control image preview style
    ...
    <div class="hidden mobile:block">
      ...
      >
        ...
        <form class="flex flex-col w-full">
          ...
          <div v-if="imgUrl.length != 0" :class="[gridWrapper, gridCols]">
            <div class="relative" v-for="(url,index) in imgUrl" :key="index">
              <img
                ...
                alt=""
              />
              <div @click="removeImage(index)" class="p-2 bg-slate-900 rounded-full absolute top-1 right-1">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
